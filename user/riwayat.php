...
<body>
  ...
  $data_pengajuan = mysqli_fetch_all(mysqli_query($koneksi, "SELECT tb_pengajuan.nik_user, tb_pengajuan.status_pengajuan,tb_pengajuan.kode_poli,tb_poli.jenis_poli FROM tb_pengajuan INNER JOIN tb_poli ON tb_pengajuan.kode_poli= tb_poli.kode_poli WHERE tb_pengajuan.nik_user='$nik'"));
  $data_antrian = mysqli_query($koneksi, "SELECT * FROM tb_antrian_keluar WHERE tb_antrian_keluar.nik_user='$nik'");
  $data_antrian_keluar = mysqli_fetch_all(mysqli_query($koneksi, "SELECT * FROM tb_antrian_keluar WHERE tb_antrian_keluar.nik_user='$nik'"));
  ?>
  ...
  <main id="main">
    ...
    <section id="services" class="services">
      <div class="container" style="margin-top: 40PX;">
        ...
        <h1 style="text-align: center; margin-top: -90px; margin-left: -75px; margin-bottom: 40px; margin-right:-200px"> RIWAYAT PENGAJUAN ANTRIAN</h1>
      </div>
      <div class="contaiiner" style="margin:100px; margin-top:100px">
        <?php
        if (mysqli_num_rows($data_antrian) == 0) {
          echo '<h1>Tidak Ada Pengajuan<h1>';
        } else {
          $y = 0;
            ...
            if ($data_pengajuan[$i][1] == 'Di Terima') { ?>
              <div class="card w-70" style="margin-bottom: 15px;">
                <div class="card-body" style="background-color:lavender;">
                  ...
                  <a href="../antrian_keluar/<?= $data_antrian_keluar[$y][4] ?>" class="btn btn-primary">Lihat Karcis</a>
                </div>
              </div>
            <?php } elseif ($data_pengajuan[$i][1] == 'Di Tolak') { ?>
              <div class="card w-70" style="margin-bottom: 15px;">
                <div class="card-body" style="background-color:lavender;">
                  <h5 class="card-title"><?= $data_pengajuan[$i][3] ?></h5>
