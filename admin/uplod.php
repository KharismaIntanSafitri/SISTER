...
<body>
    ...
    <div class="container-fluid" style="height:66%; width:70%;">
        <!-- Halaman kepala -->
        <h1>Halaman Upload</h1><br>
        <!-- Data Tabel -->
        <div class="card shadow mb-4" style="height:80%">
            <div class="card-header">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Pilih File</h6>
                </div>
            </div>
            <div class="card-body" style="margin: auto;margin-top: 10%; margin-left: 40%;">
                <form action="../update_data/update_file.php?id_pengajuan=<?= $_GET['id_pengajuan']?>&jenis_poli=<?= $_GET['jenis_poli']?>&nama=<?= $_GET['nama']?>&kode_poli<?= $_GET['kode_poli']?>"  method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-auto my-1">
                        <button type="submit" class="btn btn-primary" name="uplod">Submit</button>
                    </div>
                </form>
            </div>
        </div>
