        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="reservasi" class="collapse" aria-labelledby="headingReservasi"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../admin/diterima.php">Pengajuan Diterima</a>
                        <a class="collapse-item" href="../admin/ditolak.php">Pengajuan Ditolak</a>
            ...
            <li class="nav-item">
                ...
                <div id="surat" class="collapse" aria-labelledby="headingsurat"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Pilihan</h6>
                        <a class="collapse-item" href="../admin/semua_surat.php">Semua Antrian Keluar</a>
                    </div>
                </div>
            </li>
