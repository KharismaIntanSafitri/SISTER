...
<meta charset="UTF-8">
    ...
    <title>Admin | inputan poli anak</title>
...
<body>
    ...
    $data_anak = mysqli_fetch_assoc(mysqli_query($koneksi,"SELECT * FROM tb_anak, tb_pengajuan where id_pengajuan_anak=$id_pengajuan"));
    ?>
    <!-- Awal Isi Konten -->
                ...
                <div class="table-responsive">
                    <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td rowspan="5">8.</td>
                                <td rowspan="5">Keluhan</td>
                                <td>: <?= $data_anak["keluhan_anak"]?></td>
                            </tr>
